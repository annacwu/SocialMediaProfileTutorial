...
export const CreatePostModal = () => {
    ...
    return (
        <Modal isVisible={isPostModalOpen} style={styles.modal} onBackdropPress={closeModal}>
                <View style={styles.content}>
                    ...
                    <ContinueButton child={<ButtonText text="Create Post" />} onPress={createPost} buttonStyles={styles.createButton}/>
